...
| POST | `http://localhost:8011/api/v1/reminders` | authenticated | 리마인더 직접 생성 |
| PATCH | `http://localhost:8011/api/v1/reminders/{id}/cancel` | authenticated | 리마인더 취소 |
| GET | `http://localhost:8011/api/v1/schedules` | authenticated | 일정 목록 조회 |
| POST | `http://localhost:8011/api/v1/schedules` | authenticated | 일정 직접 생성 |
| PATCH | `http://localhost:8011/api/v1/schedules/{id}` | authenticated | 일정 수정 |
| DELETE | `http://localhost:8011/api/v1/schedules/{id}` | authenticated | 일정 삭제 |
| GET | `http://localhost:8011/api/v1/web-push/public-key` | public | Web Push 활성 여부와 VAPID public key 조회 |
| POST | `http://localhost:8011/api/v1/web-push/subscriptions` | authenticated | 브라우저 Web Push subscription 저장 |
| GET | `http://localhost:8011/api/v1/memories` | authenticated | active memory 목록 조회 |
| POST | `http://localhost:8011/api/v1/memories` | authenticated | memory 직접 생성 |
| PATCH | `http://localhost:8011/api/v1/memories/{id}` | authenticated | active memory 수정 |
| DELETE | `http://localhost:8011/api/v1/memories/{id}` | authenticated | memory soft delete |
| GET | `http://localhost:8011/api/v1/activity-events` | authenticated | assistant activity timeline 조회 |
